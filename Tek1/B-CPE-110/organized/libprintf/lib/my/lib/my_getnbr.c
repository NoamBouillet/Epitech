...
static int my_sign(int neg, int i, char const *str)
{
    if (str[i] == '-') {
        neg = neg * -1;
        return neg;
...
static int my_conditions(int i, char const *str, int rendu)
{
    if (str[i] == '+') {
        return 0;
    }
